...
```bash
tar -xzf artifacts/pulse-conversation-agent-gateway-v0.1.0-preview.19.tgz
cd pulse-conversation-agent-gateway-v0.1.0-preview.19
...
- Preview version：`0.1.0-preview.19`
- Artifact：`pulse-conversation-agent-gateway-v0.1.0-preview.19.tgz`
